package mk.ukim.finki.wp.labaratoriska233155.service.implementations;

import mk.ukim.finki.wp.labaratoriska233155.model.Chef;
import mk.ukim.finki.wp.labaratoriska233155.model.Dish;
import mk.ukim.finki.wp.labaratoriska233155.model.LabExceptions.DishNotFoundException;
import mk.ukim.finki.wp.labaratoriska233155.model.LabExceptions.NotSelectedChefException;
import mk.ukim.finki.wp.labaratoriska233155.repository.interfaces.ChefRepository;
import mk.ukim.finki.wp.labaratoriska233155.repository.interfaces.DishRepository;
